...
//Sorting Locators
@FindBy(xpath="(//*[@class='fa fa-ellipsis-v'])") //([3])
protected WebElement sortTestCase;
...
@FindBy(xpath="//*[@id='1013']/field-input/zephyr-inline-edit/div/div/span[1]")
public WebElement custom1;
...
@FindBy(xpath=".//*[@id='zui-modal-trigger-testcase_4']")
public WebElement deleteTestcase;

@FindBy(xpath=".//*[@id='zee-delete-modal-testcase_4']/div/div/div[3]/zui-modal-footer/button[2]")
...
@FindBy(xpath="html/body/ul[2]/li[3]/a")
...
@FindBy(xpath="//*[@id='zui-modal-trigger-testcase_2']")	
