...
//	public WebElement clickOnBulk;
	...
	//added by srikanth on 01/09/17
			...
			//@FindBy(xpath=".//*[@id='ze-main-app']/testcase-eas/testcase-eas-phase/div/div/div/div/div/div[1]/div[1]/span[3]")-->previous
			@FindBy(xpath=".//*[@class='pull-right unselected-star-image zui-action-icons cursor-pointer']")//26/03/18
			       ...
			       @FindBy(xpath=".//*[@id='easAddNodeModal']/div/div/div[3]/zui-modal-footer/button[2]")
		    		...
		    		//27/09/17 added
		    		 //@FindBy(xpath="//*[@id='header-parent-phase']//a/i")//previous
		    		   @FindBy(xpath="(//i[@class='fa fa-ellipsis-v'])[4]")//26/03/18
				       ...
				       @FindBy(xpath="//*[@id='th-phase_testcase_id']/div/div")
			    		...
			    		public String delete2="]/div[20]/div/div[2]/span[2]/span";//added by 26/03/18
