...
//	public WebElement options;
	...
	//For Mapping Requirements
		...
		//@FindBy(xpath=".//*[@class='zui-btn zui-btn-primary pull-right']")
		@FindBy(xpath="(//*[@class='row map-save']//button[2])[2]")
...
//			public WebElement chooseImportType;
			...
			@FindBy(xpath="(.//button[text()='Update'])[2]")//updated previous[3]
			public WebElement update;
			
			@FindBy(xpath="(.//button[text()='Update'])[3]")//[2]
...
////					   
					   public String validateGridColumn1="//*[@id='grid-table-req']/div[2]/div[";
					    ...
					    protected String check1="//*[@class='jstree-container-ul jstree-children']//*[@data-name='";
				          protected String check2="']/i";
				    			...
				    			//pagination
					 			...
					 			public String clickOnPages2="]";
						          ...
						          /*****************18/12/17 To Retrieve requirement ID'sadded by srikanth**********************/
						 			...
						 			public String requirementID2="]/div[2]/div/div";
