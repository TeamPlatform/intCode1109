...
public class Create_Projects extends LaunchBrowser{
	...
	private String project1=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_2");
	private String project2=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Isolated_Project_1");
	private String project3=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Isolated_Project_2");
	private String project4=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Restricted_Project_1");
	private String project5=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Restricted_Project_2");
	private String description=Excel_Lib.getData(INPUT_PATH, "Project_Data", 1, 0);
	private String lead=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Lead_1");
...
//	public void create_One_normal_project() throws Throwable {
		try
		{
		  ...
		  String lowerCaseProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_3");
		  ...
		  String interNationalCaseProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_4");
		  ...
		  String specialCaseProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_5");
		  ...
		  String maxCharCaseProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_6");
		  ...
		  String minCharCaseProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_7");
		  ...
		  String numberProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_9");
		  boolean result8=pp.validateProject(upperCaseProject);
		
		  if(result8==false)
		   {
		  String typeName=Excel_Lib.getData(INPUT_PATH, "Project_Data", 1, 9);
		  actual[2]=pp.createProject(numberProject, description,typeName, lead, mapDefectProject, startDate, endDate, shareCheckbox);
		  bp.waitForElement();
		   }
