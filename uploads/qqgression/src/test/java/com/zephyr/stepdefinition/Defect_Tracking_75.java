...
public class Defect_Tracking_75 extends LaunchBrowser{
	...
	DefectTracking dt;
	String fileName="Defect_Tracking_75";
	...
	try
	   {
		 ...
		 String Uname=Excel_Lib.getData(INPUT_PATH_3, "DashBoards",3,64);  
	...
	try
	   {
		 String jira_Url=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"JIRA_URL");
		 String Uname=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",3,64);
	     String Pwd=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Jira_Password");
	...
	try
	   {
		 String projectName=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",5,15);
	...
	try
	   {
		 String Username=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",3,64);  
	     String Pwd=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Jira_Password");
		 actual[19]=req.dtsLoginDetail(Username,Pwd,Pwd);
		 for(int i=0;i<=3;i++)
		 {
			 bp.waitForElement();
		 }
