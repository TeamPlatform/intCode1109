...
public class Defect_Tracking_192 extends LaunchBrowser{
	...
	String jira_Url=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"JIRA_URL");
 	...
 	String sampleProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_1");
...
//		pp.launchManageprojects();
	...
	try
    {
		...
		String minCharRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_8");
	...
	try
    {
		...
		String maxCharRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_9");
