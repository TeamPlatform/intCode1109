...
public class Defect_Tracking_25 extends LaunchBrowser{
	...
	public void user_search_the_defect_and_attach_the_excel_format_and_try_to_view_the_attachment() throws Throwable {
		try
		   ...
		   bp.waitForElement();
		   actual[11]=dt.fileNewDefect(summary_1, components, descType, desc_1, fixVersion, priority, sprint, assignee, labels, env, epicLink, affectsVersion, linkedIssue);
		   bp.waitForElement();
		   actual[12]=dt.saveDefect();
		   bp.waitForElement();
		   actual[13]=ct.uploadAttachement(filePath);
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   ...
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[14]=dt.downloadDefectAttachment(fileName);
		   bp.waitForElement();
		   bp.waitForElement();
            }
		 catch(Exception e)
	...
	public void should_be_able_to_view_the_attachment_of_defect_in_excel_format() throws Throwable {
		try
	    {
   	    String fileName=Excel_Lib.getData(INPUT_PATH_6,"DefectTracking", 2, 41);
   	    int switch_0=Excel_Lib.getNumberData(INPUT_PATH_6,"DefectTracking", 4, 0);	 
   	    actual[15]=dt.validateDownloadAttachment(fileName);
   	    bp.waitForElement();
	...
	public void user_search_the_defect_and_attach_the_word_format_and_try_to_view_the_attachment() throws Throwable {
		try
		   ...
		   bp.waitForElement();
		   actual[18]=dt.fileNewDefect(summary_1, components, descType, desc_1, fixVersion, priority, sprint, assignee, labels, env, epicLink, affectsVersion, linkedIssue);
		   bp.waitForElement();
		   actual[19]=dt.saveDefect();
		   bp.waitForElement();
		   actual[20]=ct.uploadAttachement(filePath);
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
...
//	    alert.accept();
	...
	public void user_search_the_defect_and_attach_the_image_format_and_try_to_view_the_attachment() throws Throwable {
		 try
		    ...
		    bp.waitForElement();
		    actual[25]=dt.fileNewDefect(summary_1, components, descType, desc_1, fixVersion, priority, sprint, assignee, labels, env, epicLink, affectsVersion, linkedIssue);
		    bp.waitForElement();
		    actual[26]=dt.saveDefect();
		    bp.waitForElement();
		    bp.waitForElement();
		    bp.waitForElement();
		    actual[27]=ct.uploadAttachement(filePath);	
		    bp.waitForElement();
		    bp.waitForElement();
		    bp.waitForElement();
		    bp.waitForElement();
		    ...
		    bp.waitForElement();
		    bp.waitForElement();
		    actual[28]=dt.downloadDefectAttachment(fileName);
		    bp.waitForElement();
		    bp.waitForElement();
	...
	public void user_create_subtask_and_attach_the_text_format_and_try_to_view_the_attachment() throws Throwable {
	 	try
		   ...
		   bp.waitForElement();
		   actual[42]=ct.uploadAttachement(filePath);
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
	...
	public void should_be_able_to_view_the_attachment_of_subtask_in_text_format() throws Throwable {
	    ...
	    {
   	    String fileName=Excel_Lib.getData(INPUT_PATH_6,"DefectTracking", 1, 41);
   	    actual[45]=dt.validateDownloadAttachment(fileName);
        bp.waitForElement();
        driver.navigate().back();
	    bp.waitForElement();
        driver.navigate().back();
	...
	public void user_create_subtask_and_attach_the_excel_format_and_try_to_view_the_attachment() throws Throwable {
		try
		   ...
		   int switch_1=Excel_Lib.getNumberData(INPUT_PATH_6,"DefectTracking", 4, 1);
		   int testcase=Excel_Lib.getNumberData(INPUT_PATH_6,"DefectTracking", 1, 26);
		   actual[46]=ep.clickOnDefectButton(testcase);
		   bp.waitForElement();
		   actual[47]=ep.searchDefect(defectID);	
		   bp.waitForElement();
		   actual[48]=ep.clickOnSubtask();
		   bp.waitForElement();
		   actual[49]=dt.createDefectSubtask(issuetype_1);
		   bp.waitForElement();
		   actual[50]=dt.fileNewDefect(summary_1, components, descType, desc_1, fixVersion, priority, assignee, labels, sprint, env, epicLink, affectsVersion, linkedIssue);
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[51]=dt.saveDefect();
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[52]=ct.uploadAttachement(filePath);
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   ...
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[53]=dt.downloadDefectAttachment(fileName);
		   bp.waitForElement();
		   bp.waitForElement();
	...
	public void should_be_able_to_view_the_attachment_of_subtask_in_excel_format() throws Throwable {
	    ...
	    {
   	    String fileName=Excel_Lib.getData(INPUT_PATH_6,"DefectTracking", 2, 41);
   	    actual[55]=dt.validateDownloadAttachment(fileName);
	    bp.waitForElement();
	    driver.navigate().back();
	    bp.waitForElement();
	    Alert alert = driver.switchTo().alert();
	...
	public void user_create_subtask_and_attach_the_word_format_and_try_to_view_the_attachment() throws Throwable {
		try
		   ...
		   bp.waitForElement();
		   actual[57]=ep.searchDefect(defectID);	
		   bp.waitForElement();
		   actual[58]=ep.clickOnSubTask();
		   bp.waitForElement();		   
		   actual[59]=dt.createDefectSubtask(issuetype_1);
		   bp.waitForElement();
		   actual[60]=dt.fileNewDefect(summary_1, components, descType, desc_1, fixVersion, priority, assignee, labels, sprint, env, epicLink, affectsVersion, linkedIssue);
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[61]=dt.saveDefect();
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[62]=ct.uploadAttachement(filePath);
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.waitForElement();
		   ...
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[63]=dt.downloadDefectAttachment(fileName);
		   bp.waitForElement();
		   bp.waitForElement();
	...
	public void should_be_able_to_view_the_attachment_of_subtask_in_word_format() throws Throwable {
	    ...
	    {
   	    String fileName=Excel_Lib.getData(INPUT_PATH_6,"DefectTracking", 3, 41);
   	    actual[64]=dt.validateDownloadAttachment(fileName);
   	    bp.waitForElement();
//   	driver.navigate().back();
//	    bp.waitForElement();
//	    Alert alert = driver.switchTo().alert();
//	    alert.accept();
	    actual[65]=dt.updateDefect();
	    }
	  catch(Exception e)
	    {
	    lb=new LaunchBrowser();	 
	...
	public void user_create_subtask_and_attach_the_image_format_and_try_to_view_the_attachment() throws Throwable {
		try
		   ...
		   defectNo[0]=Excel_Lib.getNumberData(INPUT_PATH_6,"DefectTracking", 1, 30);
		   int testcase=Excel_Lib.getNumberData(INPUT_PATH_6,"DefectTracking", 1, 26);
		   actual[66]=ep.clickOnDefectButton(testcase);
		   bp.waitForElement();
		   actual[67]=ep.searchDefect(defectID);	
		   bp.waitForElement();
		   actual[68]=ep.clickOnSubTask();
		   bp.waitForElement();
		   actual[69]=dt.createDefectSubtask(issuetype_1);
		   bp.waitForElement();
		   actual[70]=dt.fileNewDefect(summary_1, components, descType, desc_1, fixVersion, priority, assignee, labels, sprint, env, epicLink, affectsVersion, linkedIssue);
		   bp.waitForElement();
		   bp.waitForElement();
		   ...
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[72]=ct.uploadAttachement(filePath);	
		   bp.waitForElement();
		   bp.waitForElement();
	       bp.waitForElement();
		   bp.waitForElement();
		   ...
		   bp.waitForElement();
		   bp.waitForElement();
		   actual[73]=dt.downloadDefectAttachment(fileName);
		   bp.waitForElement();
		   bp.waitForElement();
		   bp.switchWindowTab(switch_1);
		   bp.waitForElement();
	...
	public void should_be_able_to_view_the_attachment_of_subtask_in_image_format() throws Throwable {
		try
	    {
   	    String fileName=Excel_Lib.getData(INPUT_PATH_6,"DefectTracking", 4, 41);
   	    int switch_0=Excel_Lib.getNumberData(INPUT_PATH_6,"DefectTracking", 4, 0); 
   	    actual[74]=dt.validateDownloadAttachment(fileName);
	    driver.close();
	    bp.waitForElement();
	    bp.switchWindowTab(switch_0);
	    bp.waitForElement();
	    ...
	    bp.waitForElement();
	    actual[75]=ep.clickOnCancelDefectWindow();
