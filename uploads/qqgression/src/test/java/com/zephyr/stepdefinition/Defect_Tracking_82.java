...
public class Defect_Tracking_82 extends LaunchBrowser {
	...
	String filename="Defect_Tracking_82";
	...
	public void assign_testcase_to_user_is_successfully_validated_of_all_three_level_nodes() throws Throwable {
		try
		{
		    ...
		    actual[30]=tl.navigateToCycle5(phase1);
		    bp.waitForElement();
			actual[31]=tl.validateAllAssigned(tcNo, assignee);
			bp.waitForElement();
			actual[32]=tl.navigateToCycle5(phase2);
			bp.waitForElement();
			actual[33]=tl.validateAllAssigned(tcNo, assignee);
			bp.waitForElement();
			actual[34]=tl.navigateToCycle5(phase3);
			bp.waitForElement();
