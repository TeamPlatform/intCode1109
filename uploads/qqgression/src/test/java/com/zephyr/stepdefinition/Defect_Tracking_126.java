...
public class Defect_Tracking_126 extends LaunchBrowser{
	...
	TestPlanningPage tp;
	String fileName="Defect_Tracking_126";
	...
	try
	   {
		 ...
		 String uppercaseProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_8");
	...
	try
	   {
	    String upperCaseRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_5");
		...
		bp.waitForElement();
		actual[1]=pp.selectRelease(upperCaseRelease);
		actual[2]=rp.clickOnTestRep();
		bp.waitForElement();
		actual[3]=tr.clickOnRelease(upperCaseRelease);
		bp.waitForElement();
		actual[4]=tr.addNode(p_Name1,p_Desc1);  
		String[] phase=new String[1];
		phase[0]=p_Name1;
		bp.waitForElement();
		actual[5]=tr.navigateToNode(upperCaseRelease, phase);
		for(int i=1;i<=2;i++)
		{
		tr.addTestCase();
		}
	  ...
	  actual[6]=rp.clickOnTestPlanning();
		...
		bp.waitForElement();
		actual[12]=tp.addPhaseToCycle(phase[0]);
		bp.waitForElement();
		...
		actual[14]=tp.goBackToCycle();
           ...
           bp.waitForElement();
		    ...
		    bp.waitForElement();
			actual[16]=tr.navigateToNode(upperCaseRelease, cycleName);
			bp.waitForElement();
			bp.waitForElement();
		    exep=new ExecutionPage(driver);
		    actual[17]=exep.executeStatus(tcNo1[0], statusType1);
		    actual[18]=tp.doubleClickOnCycle(upperCaseRelease);
	   }
		catch(Exception e)
		{
		   lb=new LaunchBrowser();
	...
	try
    {
		...
		String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Normal_Project_8"); 
	    String releaseName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_5");
	...
	try
	   {
		String specialCharProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_5");
	    String specialCharRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_4");
		String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",19,12);
		String p_Desc1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",100,100);
...
//		    String statusType1=Excel_Lib.getData(INPUT_PATH_3, "TestPlanning",1 ,18 );
	...
	public void user_create_a_dashBoard_and_add_daily_pulse_gadget_for_special_character_project() throws Throwable {
		try
	    {
			...
			String dashboardName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",1,60);
			String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Normal_Project_5"); 
		    String releaseName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_4");
		    String timeFrameRate=Excel_Lib.getData(INPUT_PATH_3,"Defect Tracking",2,61);
	...
	try
	   {
		String numberCharProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_9");
	    String numberCharRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_6");
	    tr=new TestRepositoryPage(driver);
		String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",19,12);
		String p_Desc1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",100,100);
	...
	try
    {
		...
		String dashboardName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",1,60);
		String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Normal_Project_9"); 
	    String releaseName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_6");
	    String timeFrameRate=Excel_Lib.getData(INPUT_PATH_3,"Defect Tracking",2,61);
	...
	try
	   {
		String alphaNumCharProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_10");
	    String alphaNumCharRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_7");
	    tr=new TestRepositoryPage(driver);
		String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",19,12);
		String p_Desc1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",100,100);
		bp.waitForElement();
	...
	try
    {
		...
		String dashboardName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",1,60);
		String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Normal_Project_10"); 
	    String releaseName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_7");
	    String timeFrameRate=Excel_Lib.getData(INPUT_PATH_3,"Defect Tracking",2,61);
	...
	try
	   {
		String internationalCharProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_4");
	    String internationalCharRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_3");
	    tr=new TestRepositoryPage(driver);
		String p_Name1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",19,12);
		String p_Desc1=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",100,100);
		bp.waitForElement();
	...
	try
    {
		...
		pp=new ProjectPage(driver);
		String dashboardName=UNIQUE+Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking",1,60);
		String projectName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Normal_Project_4"); 
	    String releaseName=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_3");
	    String timeFrameRate=Excel_Lib.getData(INPUT_PATH_3,"Defect Tracking",2,61);
