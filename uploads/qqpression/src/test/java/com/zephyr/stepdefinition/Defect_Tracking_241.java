...
public class Defect_Tracking_241 extends LaunchBrowser{
		...
		try
	      {
		   ...
		   String name=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Manager_Username_1");
	...
	public void user_set_the_dts_to_jira() throws Throwable {
		 try
		   ...
		   String url=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"JIRA_URL");
...
public void should_be_Able_to_launch_TestExecution() throws Throwable {
	...
	public void user_Add_Overall_Gadget() throws Throwable {
		 try
		   ...
		   String release=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_1");
	...
	public void user_change_the_status_from_Done_to_TO_DO() throws Throwable {
		 try
		   ...
		   int switch_0=Excel_Lib.getNumberData(INPUT_PATH_6,"DefectTracking", 4, 0);	 	 
		   String username=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Jira_Username");
		   String password=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Jira_Password");	 	 	 	 		  		   String statusType=Excel_Lib.getData(INPUT_PATH_6,"DefectTracking", 3, 8);
		   String defectID=Excel_Lib.getData(INPUT_PATH_6,"DefectTracking", 3, 10);	 
		   bp.waitForElement();
