...
public class Defect_tracking_124 extends LaunchBrowser{
	...
	String alphaNumProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_10");
    ...
    {	 
		 ...
		 bp=new BasePage();
	     String Mname=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Manager_Username_1");
	     String Mpass=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Manager_Password_1");
	     pp.clickOnLogout();
	     lp.enterUname(Mname);
	     lp.enterPass(Mpass);
	     bp.waitForElement();
	...
	public void create_a_different_types_of_releases_for_the_projects() throws Throwable {
		try
	    {
			...
			bp.waitForElement();
			String upperRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_5");
			...
			rp.clickOnManageRelease();
			String numberRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_6");
			...
			rp.clickOnManageRelease();
			String alphaNumRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_7");
			...
			rp.clickOnManageRelease();
			String internationalCharRelease=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE,"Release_6");
	...
	try
	   {
		 String numberProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_10");
		 String jiraProjectName=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 2,0);
		 driver.navigate().to(zephyr_Url);
		 pp.launchAdministration();
		 pp.launchManageprojects();
	...
	try
	   {
		 String numberProject=Property_Lib.getPropertyValue(CONFIG_PATH+CONFIG_FILE_TPE, "Normal_Project_4");
		 String jiraProjectName=Excel_Lib.getData(INPUT_PATH_3, "Defect Tracking", 2,0);
		 driver.navigate().to(zephyr_Url);
		 pp.launchAdministration();
		 pp.launchManageprojects();
