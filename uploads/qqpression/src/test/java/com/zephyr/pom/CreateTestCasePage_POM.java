...
//	     public WebElement enterTags;
	   ...
	   //Single test Case Custom
	     ...
	     //6.1 version
	     @FindBy(xpath="//div/zee-custom-fields//span[contains(@title, 'CustomCheckbox')]/following-sibling::span//input")
	         protected WebElement customCheckbox;
	     ...
	     // protected WebElement customPicklist;
	       ...
	       //6.1 version
	         @FindBy(xpath="div[@class='col-md-12 col-xs-12']//li[5]//span/input")
	         protected WebElement customText1;
	       ...
	       //6.1 version
	       @FindBy(xpath="div[@class='col-md-12 col-xs-12']//li[6]//span/input")
	       protected WebElement customlongText1;
		         ...
		         //6.0  @FindBy(xpath="//*[@id='zee-create-edit-modal-tcr_3']//ul/li[5]/div/span/input")
		          ...
		          //6.1 version 
		          @FindBy(xpath="//div[@class='col-md-12 col-xs-12']//li[2]//input")
		          protected WebElement customChkbox1; 
		          ...
		          // 6.1 version
		          @FindBy(xpath="//div[@class='col-md-12 col-xs-12']//li[3]//span/input")
		          protected WebElement customNumber1;
		             
		          @FindBy(xpath="//*[@id='zee-create-edit-modal-tcr_3']//ul/li[7]/div/span")
		         ...
		         // protected WebElement customPicklist1;
		          ...
		          //6.1 version
		          @FindBy(xpath="//div[@class='col-md-12 col-xs-12']//li[1]//select")
		          protected WebElement customPicklist1;
