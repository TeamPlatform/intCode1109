...
public class CreateCustomFieldsPage_POM {
	...
	// ****6.1 x path***/
	@FindBy(xpath = "//*[@id='fields-modal']/div/div/div[2]/zui-modal-body/div[3]/form/div/div[2]/div/div/div[2]/input")
	...
	@FindBy(xpath = "(//*[@class='zui-btn zui-btn-primary' and text()='Save'])[2]")
	   ...
	   @FindBy(xpath="//*[@placeholder='Enter Value']")
		 ...
		 public String Checkbox="//*[@id='preference-active']";
			...
			//Added
			 ...
			 @FindBy(xpath="//*[@id='execution-status-modal']//button")
